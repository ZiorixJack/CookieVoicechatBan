...
public class UnVCBanCommand implements BasicCommand {
    private final CookieVCBan plugin;
    private final MiniMessage miniMessage;

    public UnVCBanCommand(CookieVCBan plugin) {
        this.plugin = plugin;
    ...
    public void execute(@NotNull CommandSourceStack stack, @NotNull String[] args) {
        ...
        if (args.length < 1) {
            sender.sendMessage(miniMessage.deserialize("<red>Usage: /unvcban <player></red>"));
            return;
        }
